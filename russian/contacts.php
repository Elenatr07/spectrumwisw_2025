                    ...
                    <form action="../sender.php" method="post" id="formmain">
                        ...
                        <div class="name" id="border_email">
                         ...
                         <div class="select_list">
                                <ul>
                                    <li class="select_list_item">Бизнес под ключ</li>
                                    <li class="select_list_item">Создание сайтов</li>
                                    <li class="select_list_item">Графический дизайн</li>
                                    <li class="select_list_item">Цифровой маркетинг</li>
                                    <li class="select_list_item">Быстрые решения</li>
                                </ul>
                            </div>
            ...
            <div class="footer_wrapper">
                <div class="footer_block">
                    <div class="footer_logo">
                        <a href="index.html" title="logo" class="footer_logo_img"></a>
                        <div class="footer_lang">
                            <div  class="button_block">
                                <div class="dropbtn">
                                    <div id="button_view_footer"   class="button_view prog3">
                                        <div id="drop_footer_lang"></div>
                                        <div class="row_down foot"></div>
