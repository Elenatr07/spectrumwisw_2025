...
<div class="darkmode"> <a href="dark.php" class="style_mode">View in Dark Mode</a> </div> <!--only for style mode-->
    <div class="container_main"> 
        ...
        <div class="form_send_block" id="contacts">
            ...
            <form action="" method="post" id="formmain">
                ...
                <input type="hidden" name="formInfo" value="Order litemode RAYNCE">
            </form>
            </div>
